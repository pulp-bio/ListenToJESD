...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "DESCRAMBLING" -parent ${Page_0} -widget comboBox
...
proc update_PARAM_VALUE.DESCRAMBLING { PARAM_VALUE.DESCRAMBLING } {
	# Procedure called to update DESCRAMBLING when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.DESCRAMBLING { PARAM_VALUE.DESCRAMBLING } {
	# Procedure called to validate DESCRAMBLING
	return true
}
...
proc update_MODELPARAM_VALUE.DESCRAMBLING { MODELPARAM_VALUE.DESCRAMBLING PARAM_VALUE.DESCRAMBLING } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.DESCRAMBLING}] ${MODELPARAM_VALUE.DESCRAMBLING}
}
